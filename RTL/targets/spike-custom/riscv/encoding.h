...
//priv-code-lock begin
#define CSR_SPCODEBASE0	0x190
#define CSR_SPCODEBASE1	0x191
#define CSR_SPCODEBASE2	0x192
#define CSR_SPCODEBASE3	0x193
#define CSR_ISOLATIONSW 0x198
#define CSR_STOREMONITOR 0x199
#define CSR_VPOFFSET 0x182
//priv-code-lock end
...
//priv-code-lock begin
DECLARE_CSR(isolationsw, CSR_ISOLATIONSW)
DECLARE_CSR(storemonitor, CSR_STOREMONITOR)
DECLARE_CSR(vpoffset, CSR_VPOFFSET)
DECLARE_CSR(spcodebase0, CSR_SPCODEBASE0)
DECLARE_CSR(spcodebase1, CSR_SPCODEBASE1)
DECLARE_CSR(spcodebase2, CSR_SPCODEBASE2)
DECLARE_CSR(spcodebase3, CSR_SPCODEBASE3)
//priv-code-lock end
